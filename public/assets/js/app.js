 ...
 */
const l = ['/admin/admin/notic_list','/admin/order/usdt_list','/user/task/task_list','/admin/task/task_list','/admin/account/list','/api/user/init.json','/api/admin/init.json','/user/order/check'];
const loading = $.confirm({
    title:"",
    lazyOpen: true,
    buttons:{
        ok:{
